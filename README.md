...
No cloud, no OpenAI/Claude/Gemini/xAI, no internet required after setup. Roleplay bot - but ideally could edit to add library collection data and make functional? Work in progress..
